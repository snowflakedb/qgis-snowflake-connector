...
from ..ui.sf_data_source_manager_widget import Ui_QgsDbSourceSelectBase
...
class SFDataSourceManagerWidget(QgsAbstractDataSourceWidget, Ui_QgsDbSourceSelectBase):
    ...
    def on_btn_new_clicked(self) -> None:
        ...
        try:
            ...
            self.sf_connection_string_dialog.exec()
        except Exception as e:
            QMessageBox.information(
                None,
                "New Connection",
